...
if ( class_exists('GFForms' ) ) :
	...
	class GFSolve extends GFAddOn {
		...
		public function after_submission( $entry, $form ) {
			...
			$websites				= array(); // contact website activities
			...
			if ( isset( $contact->errors ) ) {
				...
				foreach ( $websites as $website ) {
					$this->solveService->addActivity( $contact_id, 'website', $website );
				}
				...
				do_action( $this->_slug . '_contact_processed', $status, $contact, $contact_data, $notes, $websites );
			}
